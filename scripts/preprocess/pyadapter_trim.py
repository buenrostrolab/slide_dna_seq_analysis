...
opts.add_option("-c", help="<Output Read1> Accepts fastq or fastq.gz")
opts.add_option("-d", help="<Output Read2> Accepts fastq or fastq.gz")
...
if options.u == False:
    r1_write = gzip.open(p1_out, 'wb')
    r2_write = gzip.open(p2_out, 'wb')
elif options.u == True:
